  ...
  return (
    <>
      ...
      <div className="blog-index">
        ...
        <ul>
          {blogsList.map((blog) => (
            <li key={blog.id}>{blog.title}, {blog.creator}, {blog.content}, {blog.category}, {blog.published ? "published" : "unpublished"} <button className="btn-1" onClick={() => handleDelete(blog.id)}>🗑️</button></li>
          ))}
        </ul>
